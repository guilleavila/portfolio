...
const Footer = () => {
    return (
        <div className={`${styles.paddingX} fixed bottom-10 z-20 flex flex-col md:flex-row gap-5 mt-20 mb-20 md:mb-0 justify-between items-center w-full opacity-0 footer`}>
